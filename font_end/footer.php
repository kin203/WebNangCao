<footer class="page-footer font-small blue-grey lighten-5" style="background-color:white">
  ...
  <div style="background-color: #D70018;">
    <div class="container">
  ...
  <div class="container text-center text-md-left mt-5">
    ...
    <div class="row mt-3 dark-grey-text">
      ...
      <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
        ...
        <p>
          <i class="fas fa-envelope mr-3"></i>TKLcontact@sale.com
        </p>
        <p>
          <i class="fas fa-phone mr-3"></i>0988668669
        </p>
        <p>
          <i class="fas fa-print mr-3"></i> + 09 668 789
        </p>
  ...
  <div class="footer-copyright text-center text-black-50 py-3">© 2023 Copyright:
    <a class="dark-grey-text" href="index.html">TKLShop.com</a>
  </div>
  <!-- Copyright -->
