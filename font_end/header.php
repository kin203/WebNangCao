  ...
  <nav>
    ...
    <div class="icon-nav">
      ...
      foreach ($cart as $item) {
          // Check if 'num' key exists in the $item array
      ...
      <div class="Client">
        <?php if (isset($_SESSION['userclient'])) : ?>
            <p style="color:white;margin-top:15px">Xin chào <?php echo $_SESSION['userclient']; ?> !</p>
            <a style="color: #fff;" class="users" href="Logout.php"><i class="fas fa-sign-out-alt"></i></a>
        <?php else : ?>
